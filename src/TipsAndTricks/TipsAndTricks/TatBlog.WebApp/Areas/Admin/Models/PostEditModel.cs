...
{
    private IEnumerable<SelectListItem> authorList;
    ...
    public IEnumerable<SelectListItem> AuthorList { get => authorList; set => authorList = value; }
    public IEnumerable<SelectListItem> CategoryList { get => categoryList; set => categoryList = value; }
